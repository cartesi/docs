...
resources:
  - url: https://github.com/cartesi/rollups-contracts/blob/v3.0.0-alpha.9/src/withdrawal/UsdWithdrawalOutputBuilderFactory.sol
    title: UsdWithdrawalOutputBuilderFactory contract
  - url: https://github.com/cartesi/rollups-contracts/blob/v3.0.0-alpha.9/src/withdrawal/IUsdWithdrawalOutputBuilderFactory.sol
...
The factory is constructed with a shared `SafeErc20Transfer` contract, which it passes to every builder it deploys as the delegate-call voucher destination.
