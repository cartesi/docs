...
:::caution
If you are using Docker Desktop, make sure to update it to the latest version. If you are using Homebrew to install Sunodo, navigate to _Settings > Resources > File sharing_ and add the following path: `/opt/homebrew/Cellar/sunodo`.
:::
