...
#### [`validity`](#) ([`OutputValidityProof!`](/cartesi-rollups/next/api/graphql/objects/output-validity-proof))

Validity proof for an output


#### [`context`](#) ([`String!`](/cartesi-rollups/next/api/graphql/scalars/string))
