...
The [`CartesiDApp`](../base-layer-contracts/application.md) contract is crucial in validating and executing the received voucher on the blockchain. This execution process occurs through the [`executeVoucher()`](../base-layer-contracts/application.md/#executevoucher) function, ensuring that the action specified in the voucher is legitimate and authorized.
...
[Refer to the documentation here](../../build/asset-handling.md) for asset handling and creating vouchers in your dApp.
:::
...
:::note epoch duration
[Refer to the documentation here](../../build/cli-commands.md/#run) to manually configure epoch length during development.
:::
