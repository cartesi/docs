...
- The [`CartesiDApp`](../api/base-layer-contracts/application.md) contract executes the voucher using the [`executeVoucher()`](../api/base-layer-contracts/application.md/#executevoucher) function.
...
- Notices are validated on-chain using the [`validateNotice()`](../api/base-layer-contracts/application.md/#validatenotice) function of the [`CartesiDApp`](../api/base-layer-contracts/application.md) contract.
