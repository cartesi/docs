...
- [Ether (ETH)](../api/base-layer-contracts/portals/)
- [ERC-20](../api/base-layer-contracts/portals/ERC20Portal.md)
- [ERC-721](../api/base-layer-contracts/portals/ERC721Portal.md)
- [ERC-1155 Single](../api/base-layer-contracts/portals/ERC1155SinglePortal.md)
- [ERC-1155 Batch](../api/base-layer-contracts/portals/ERC1155BatchPortal.md)
...
By calling `relayDAppAddress()`, function of the `DAppAddressRelay` contract, it adds the dApp’s address as a new input for the Cartesi dApp to process. Next, the off-chain machine uses this address to generate a voucher for execution at the [`executeVoucher()`](../api/base-layer-contracts/application.md/#executevoucher) function of the `CartesiDApp` contract.
...
| :------- | :------------- | :------------------------------------------------------------------------------------------------------------------------------------------ |
| Ether    | dApp contract  | `withdrawEther(address,uint256)` [:page_facing_up:](../api/base-layer-contracts/application.md/#withdrawether)                            |
