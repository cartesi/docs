...
Now that we've confirmed our count value to be zero (0), we would be sending an advance request using the CLI to increase he value of our counter by running the below command:
