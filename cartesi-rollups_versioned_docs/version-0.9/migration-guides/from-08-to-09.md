...
All [Epoch objects](../../version-0.8/api/graphql/objects/epoch.mdx) have been removed. This includes:

* `EpochConnection`
* `EpochEdge`
* `Epoch`

All [Epoch queries](../../version-0.8/api/graphql/queries/epoch.mdx) have been removed. This includes:
