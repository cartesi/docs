...
Now that we have described the [architecture of a Cartesi DApp](../cartesi-rollups/dapp-architecture.md) and how [the front-end and back-end communicate with the Cartesi Rollups framework](../cartesi-rollups/http-api.md), let’s step back a bit to discuss how a DApp can be implemented in practice.
