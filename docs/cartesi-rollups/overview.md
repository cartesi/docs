...
* [**Cartesi Machine**](../machine/intro), a virtual machine (VM) that runs an entire Linux OS, in which each DApp's [back-end](../cartesi-rollups/dapp-architecture/#back-end) is executed.
