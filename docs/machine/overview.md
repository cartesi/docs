...
The [Cartesi Machine Emulator](https://github.com/cartesi/machine-emulator) is the reference off-chain implementation of the Cartesi Machine Specification. It is written in C/C++ with POSIX dependencies restricted to the terminal, process, and memory-mapping facilites. It is distributed as a library and scriptable in the Lua programming language.
